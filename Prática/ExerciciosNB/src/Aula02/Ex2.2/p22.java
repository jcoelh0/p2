...
public class p22 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < cl.length; i++) {
			System.out.println("Nome: " + cl[i].nome());
			System.out.println("Telefone: " + cl[i].telefone());
			System.out.println("Email: " + cl[i].eMail());
			System.out.println();
		}
		...
		System.out.println("Contactos: " + Contacto.numContactos());
	}
}
